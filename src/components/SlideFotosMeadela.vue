<template>
  <div style="margin:15px">
    <h1>Gestão de slide de fotos</h1>
...
export default {
  ...
  if(this.fileEmCondicoes){
    ...
    try{
    // await 
    //  axios.post("http://meadelagym.pt/projeto4dev/api/inserirSlideFotosMeadela?id=1",formData);

      axios({
        method: "post",
        url: "http://meadelagym.pt/projeto4dev/api/inserirSlideFotosMeadela?id=1",
        data: formData,
  ...
  if(this.fileEmCondicoes){
    ...
    // try{
    // await 
    //  axios.post("http://meadelagym.pt/projeto4dev/api/updateSlideFotosMeadela",formData);

      axios({
        method: "post",
        url: "http://meadelagym.pt/projeto4dev/api/updateSlideFotosMeadela",
        data: formData,
        headers: { "Content-Type": "multipart/form-data" },
      })
