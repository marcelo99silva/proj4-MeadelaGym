<template>
  <div class="footerDiv">
      <b-container>
        <b-row>
          <b-col class="info">
            <div class="md-title">OrthoGym</div>
            <br>
          ...
          <b-col class="paginas">
            ...
            <div class="md-content">
              <ul>
                <li><router-link to="/orthoGym/Servicos/0" >Produtos</router-link></li>
                <li><router-link to="/orthoGym/Sobre">Sobre</router-link></li>
                <li><router-link to="/orthoGym/Contactos">Contactos</router-link></li>
              </ul>
            </div>
          </b-col>
...
<script>
  export default {
    data(){
      return {
        info: {
          localizacao: "Rua de S. Vicente 562, 4900 – 818 Meadela",
          contacto: "968 668 350",
          email: "geral@meadelagym.pt"
        }
      }
    }
  }
