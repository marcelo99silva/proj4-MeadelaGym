<template>
  <div class="home">
    ...
    <div class="corpo">
      <b-container fluid>
        <b-row class="info justify-content-md-center">
          <b-col>
            <div class="divmap">
        ...
        <b-row class="justify-content-md-center">
          <b-form @submit="onSubmit" >
            ...
            <div class="form-row">
              <div class="col">
                <b-button type="submit" style="background-color: #EE933C;" variant="primary">Enviar</b-button>
              </div>
              <div class="col">
  ...
  export default {
    ...
    methods: {
      ...
      onSubmit() {
        axios({
          method: "post",
          url: "http://meadelagym.pt/projeto4dev/api/email/form?id=1",
          data: {
            nome: this.form.nome,
