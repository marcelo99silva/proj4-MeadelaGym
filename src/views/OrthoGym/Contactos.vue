      ...
      <b-container fluid>
        ...
        <b-row class="justify-content-md-center">
          <b-form @submit="onSubmit" >
            ...
            <div class="form-row">
              <div class="col">
                <b-button type="submit" style="background-color: #004AFF;" variant="primary">Enviar</b-button>
              </div>
              <div class="col">
...
<script>
  ...
  export default {
    ...
    data(){
      return {
        bannerImage: 'ortho/banner_contactos.png',
        info: {
          localizacao: null,
          contacto: null,
          email: null
    ...
    methods: {
      ...
      onSubmit() {
        axios({
          method: "post",
          url: "http://meadelagym.pt/projeto4dev/api/email/form?id=3",
          data: {
            nome: this.form.nome,
